<template>
  <div class="app-container">
    <el-form :inline="true" :model="formInline" size="small">
      <el-form-item :label="$t('baseCms.list.queryForm.name')">
        <el-input v-model="formInline.name" :placeholder="$t('baseCms.list.queryForm.name')" clearable></el-input>
      </el-form-item>
      <el-form-item :label="$t('baseCms.list.queryForm.type')">
      <el-select v-model="formInline.type"  :placeholder="$t('baseCms.list.queryForm.type')" clearable >
        <el-option
      ...
      <el-form-item>
        ...
        <auth-button type="primary" perms="yqkj_shop_manage_add" :label="$t('common.table.addBtn')" @click="addOrEdit(0)" icon="el-icon-circle-plus"/>
      </el-form-item>
    </el-form>
    <el-table
